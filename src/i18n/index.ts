...
import ptLegal from "./locales/pt/legal";
...
import nlLegal from "./locales/nl/legal";
...
import svLegal from "./locales/sv/legal";
...
import plLegal from "./locales/pl/legal";
...
import idLegal from "./locales/id/legal";
...
import trLegal from "./locales/tr/legal";
...
import ruLegal from "./locales/ru/legal";
...
import jaLegal from "./locales/ja/legal";
...
import koLegal from "./locales/ko/legal";
...
import zhLegal from "./locales/zh/legal";
export const translations = {
    en: { home: enHome, menu: enMenu, ui: enUI, store: enStore, widgets: enWidgets, legal: enLegal },
    fr: { home: frHome, menu: frMenu, ui: frUI, store: frStore, widgets: frWidgets, legal: frLegal },
    de: { home: deHome, menu: deMenu, ui: deUI, store: deStore, widgets: deWidgets, legal: deLegal },
    it: { home: itHome, menu: itMenu, ui: itUI, store: itStore, widgets: itWidgets, legal: itLegal },
    pt: { home: ptHome, menu: ptMenu, ui: ptUI, store: ptStore, widgets: ptWidgets, legal: ptLegal },
    nl: { home: nlHome, menu: nlMenu, ui: nlUI, store: nlStore, widgets: nlWidgets, legal: nlLegal },
    sv: { home: svHome, menu: svMenu, ui: svUI, store: svStore, widgets: svWidgets, legal: svLegal },
    pl: { home: plHome, menu: plMenu, ui: plUI, store: plStore, widgets: plWidgets, legal: plLegal },
    id: { home: idHome, menu: idMenu, ui: idUI, store: idStore, widgets: idWidgets, legal: idLegal },
    tr: { home: trHome, menu: trMenu, ui: trUI, store: trStore, widgets: trWidgets, legal: trLegal },
    ru: { home: ruHome, menu: ruMenu, ui: ruUI, store: ruStore, widgets: ruWidgets, legal: ruLegal },
    ja: { home: jaHome, menu: jaMenu, ui: jaUI, store: jaStore, widgets: jaWidgets, legal: jaLegal },
    ko: { home: koHome, menu: koMenu, ui: koUI, store: koStore, widgets: koWidgets, legal: koLegal },
    zh: { home: zhHome, menu: zhMenu, ui: zhUI, store: zhStore, widgets: zhWidgets, legal: zhLegal },
} as const; export type TranslationKeys = typeof translations;
